...
/* harmony import */ var _ecomplus_search_engine__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ecomplus/search-engine */ "./node_modules/@ecomplus/search-engine/src/index.js");
/* harmony import */ var _components_ShippingLine_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! #components/ShippingLine.vue */ "./node_modules/@ecomplus/storefront-components/src/ShippingLine.vue");
/* harmony import */ var _EcSummary_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./../EcSummary.vue */ "./node_modules/@ecomplus/storefront-app/src/components/EcSummary.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'EcOrderInfo',
  components: {
    ShippingLine: _components_ShippingLine_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    EcSummary: _EcSummary_vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  props: {
    order: {
      type: Object,
  ...
  computed: {
    i19buyAgain: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19buyAgain"]),
    i19cancelOrder: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19cancelOrder"]),
    i19codeCopied: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19codeCopied"]),
    i19copyCode: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19copyCode"]),
    i19copyErrorMsg: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19copyErrorMsg"]),
    i19doPaymentMsg: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19doPaymentMsg"]),
    ...
    i19loginForOrderDetailsMsg: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19loginForOrderDetailsMsg"]),
    ...
    i19notes: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19notes"]),
    i19of: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19of"]),
    i19orderConfirmationMsg: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19orderConfirmationMsg"]),
    i19orderNumber: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19orderNumber"]),
    i19printBillet: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19printBillet"]),
    i19redirectToPayment: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19redirectToPayment"]),
    i19referenceCode: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19referenceCode"]),
    i19reopenOrder: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19reopenOrder"]),
    i19shippingAddress: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19shippingAddress"]),
    i19transactionCode: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19transactionCode"]),
    i19ticketCode: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19ticketCode"]),
    i19trackDelivery: () => Object(_ecomplus_utils__WEBPACK_IMPORTED_MODULE_1__["i18n"])(_ecomplus_i18n__WEBPACK_IMPORTED_MODULE_0__["i19trackDelivery"]),
  ...
  methods: {
    ...
    saveCustomerOrder() {
      ...
      if (!this.skipCustomerUpdate && localOrder.number && ecomPassport.checkAuthorization()) {
        ecomPassport.requestApi('/me.json').then(({
          data
        }) => {
    ...
    buyAgain() {
      ...
      if (localOrder.items) {
        ...
        _ecomplus_shopping_cart__WEBPACK_IMPORTED_MODULE_4__["default"].clear();
        items.forEach((item, i) => {
          _ecomplus_shopping_cart__WEBPACK_IMPORTED_MODULE_4__["default"].addItem(item, false);

          if (i + 1 === items.length) {
            _ecomplus_shopping_cart__WEBPACK_IMPORTED_MODULE_4__["default"].save();
    ...
    toggle() {
      ...
      _ecomplus_passport_client__WEBPACK_IMPORTED_MODULE_3__["default"].requestApi(`/orders/${this.order._id}.json`, 'patch', data).then(() => {
      ...
      handler(isLoaded) {
        if (isLoaded && this.isAuthenticated && this.status === 'cancelled') {
          ...
          if (items && items.length) {
            ...
            const search = new _ecomplus_search_engine__WEBPACK_IMPORTED_MODULE_5__["default"]();
            search.setPageSize(productIds.length).setProductIds(productIds).fetch(true).then(() => {
              for (let i = 0; i < items.length; i++) {
                const orderItem = items[i];
                const product = search.getItems().find(({
                  _id
  ...
  created() {
    if (this.order._id) {
      ...
      if (!this.skipDataLoad) {
        ...
        const update = () => {
          const request = this.ecomPassport.checkAuthorization() ? this.ecomPassport.requestApi(url) : Object(_ecomplus_client__WEBPACK_IMPORTED_MODULE_2__["store"])({
            url
          });
          return request.then(({
            data
    ...
    [
      ...
      _vm.accountOrdersUrl
        ? _c(
            ...
            [
              _c("i", { staticClass: "fas fa-chevron-left mr-1" }),
              _vm._v("\n    " + _vm._s(_vm.i19myOrders) + "\n  ")
            ]
          )
        : _vm._e()
...
//# sourceMappingURL=chunk.6cd186a0058d8bceeacf.js.map