...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  if (typeof window.fbq === 'function') {
    const track = function (evName) {
      let data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      let isCustomEv = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  ...
  if (router) {
    ...
    const getPurchaseData = () => {
      ...
      if (_ecomplus_shopping_cart__WEBPACK_IMPORTED_MODULE_0__["default"].data && Array.isArray(_ecomplus_shopping_cart__WEBPACK_IMPORTED_MODULE_0__["default"].data.items)) {
        _ecomplus_shopping_cart__WEBPACK_IMPORTED_MODULE_0__["default"].data.items.forEach(_ref => {
          let {
            sku,
            quantity
          } = _ref;
...
//# sourceMappingURL=chunk.7e81864bc291e38d30b3.js.map