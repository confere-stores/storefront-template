...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchOrder() {
      const url = "/orders/".concat(this.orderBody._id, ".json");
    ...
    if (!this.skipDataLoad) {
      if (this.order._id) {
        ...
        this.ecomPassport.fetchOrdersList().then(orders => {
          this.localOrder = orders.find(_ref2 => {
            let {
              number
            } = _ref2;
            return number === this.order.number;
          }) || {};
        });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: { ...Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])(['orders']),
    ...
    order() {
      const order = this.orders.find(_ref => {
        let {
          _id,
          number
        } = _ref;
...
// Module
exports.push([module.i, ".order{min-height:300px}", "",{"version":3,"sources":["EcOrder.scss"],"names":[],"mappings":"AAIA,OACE,gBAHF","file":"EcOrder.scss","sourcesContent":["$primary: #e83e8c; $secondary: #333333; $settings-theme: (\n  bootswatch: _,\n  custom: _\n); \n.order {\n  min-height: 300px;\n}\n"]}]);
// Exports
...
//# sourceMappingURL=chunk.6fd259bf00388242e416.js.map