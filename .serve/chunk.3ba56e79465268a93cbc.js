    ...
    if (isSearchPage) {
      ...
      if (context && context.body) {
        ...
        switch (context.resource) {
          case 'categories':
            defaultList = "Category: ".concat(name);
            break;

          case 'brands':
            defaultList = "Brand: ".concat(name);
            break;

          case 'collections':
            defaultList = "Collection: ".concat(name);
        }
      }
    }
...
/* harmony default export */ __webpack_exports__["default"] = (dataLayer => {
  ...
  _ecomplus_shopping_cart__WEBPACK_IMPORTED_MODULE_0__["default"].on('addItem', _ref => {
    let {
      item
    } = _ref;
    return emitAddToCart(item);
  });
  _ecomplus_shopping_cart__WEBPACK_IMPORTED_MODULE_0__["default"].on('increaseItemQnt', _ref2 => {
    let {
      item
    } = _ref2;
    const productData = productsBySku[item.sku];
  ...
  _ecomplus_shopping_cart__WEBPACK_IMPORTED_MODULE_0__["default"].on('removeItem', _ref3 => {
    let {
      item
    } = _ref3;
...
//# sourceMappingURL=chunk.3ba56e79465268a93cbc.js.map